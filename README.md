...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/doppler-cli-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/doppler-cli-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add doppler-cli
# for installing globally
pixi global install doppler-cli
```
...
It is possible to list all of the versions of `doppler-cli` available on your platform:
...
```
pixi search doppler-cli --channel conda-forge
```
